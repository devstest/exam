...
# default location: /home/vagrant/jenkins
...
# Run helloworld job
# Allow anonymous read access in the Global Security Section
#java -jar /home/vagrant/$SYNC_FOLDER/jenkins-cli.jar -s http://127.0.0.1:${JENKINS_PORT}/ --username admin --password $JENKINS_PASS build helloworld_job
